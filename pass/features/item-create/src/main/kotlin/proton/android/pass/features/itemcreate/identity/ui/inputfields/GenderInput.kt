...
internal fun GenderInput(
    ...
    ProtonTextField(
        ...
        editable = enabled,
        label = { ProtonTextFieldLabel(text = stringResource(id = R.string.identity_field_gender_title)) },
        placeholder = {
            ProtonTextFieldPlaceHolder(
                text =
                stringResource(id = R.string.identity_field_gender_hint)
            )
        },
        trailingIcon = {
            if (value.isNotEmpty()) {
