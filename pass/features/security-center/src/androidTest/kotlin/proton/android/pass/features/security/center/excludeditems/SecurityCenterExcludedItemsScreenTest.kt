...
package proton.android.pass.features.security.center.excludeditems
...
@HiltAndroidTest
class SecurityCenterExcludedItemsScreenTest {
            ...
            setContent {
                PassTheme(isDark = true) {
                    SecurityCenterExcludedItemsScreen(
                        onNavigated = {
                            if (it is SecurityCenterExcludeItemsDestination.Back) {
                                checker.call()
                            }
                        }
                    )
