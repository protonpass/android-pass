...
class ObserveBreachProtonEmailsImpl @Inject constructor(
    private val observeCurrentUser: ObserveCurrentUser,
    private val breachRepository: BreachRepository
) : ObserveBreachProtonEmails {

    override fun invoke(): Flow<List<BreachProtonEmail>> = observeCurrentUser()
        .flatMapLatest { user ->
            breachRepository.observeProtonEmails(user.userId)
        }
