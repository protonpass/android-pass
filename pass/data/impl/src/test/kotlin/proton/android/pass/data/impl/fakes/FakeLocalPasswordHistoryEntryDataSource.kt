...
class FakeLocalPasswordHistoryEntryDataSource : LocalPasswordHistoryEntryDataSource {

    override suspend fun addOnePasswordHistoryEntryForUser(passwordHistoryEntity: PasswordHistoryEntity) {}

    override suspend fun getPasswordHistoryEntryForUser(userId: UserId): List<PasswordHistoryEntity> = emptyList()

    override fun observePasswordHistoryEntryForUser(userId: UserId): Flow<List<PasswordHistoryEntity>> = emptyFlow()
