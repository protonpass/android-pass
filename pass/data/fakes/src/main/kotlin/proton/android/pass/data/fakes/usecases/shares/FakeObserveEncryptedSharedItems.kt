...
@Singleton
class FakeObserveEncryptedSharedItems @Inject constructor() : ObserveEncryptedSharedItems {

    private val sharedItemsFlow: MutableSharedFlow<List<ItemEncrypted>> = testFlow()
