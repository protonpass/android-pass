...
@Composable
internal fun WorkPhoneNumberInput(
    ...
    ProtonTextField(
        ...
        editable = enabled,
        label = { ProtonTextFieldLabel(text = stringResource(id = R.string.identity_field_work_phone_number_title)) },
        placeholder = {
            ProtonTextFieldPlaceHolder(
                text =
                stringResource(id = R.string.identity_field_work_phone_number_hint)
            )
        },
        trailingIcon = {
            if (value.isNotEmpty()) {
