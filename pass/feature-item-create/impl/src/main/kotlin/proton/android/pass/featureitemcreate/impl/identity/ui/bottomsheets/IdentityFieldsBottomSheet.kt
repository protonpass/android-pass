...
import proton.android.pass.featureitemcreate.impl.identity.presentation.bottomsheets.IdentityFieldsEvent
import proton.android.pass.featureitemcreate.impl.identity.presentation.bottomsheets.IdentityFieldsViewModel
...
fun IdentityFieldsBottomSheet(
    ...
    LaunchedEffect(state.event) {
        when (state.event) {
            IdentityFieldsEvent.OnSelect -> onNavigate(IdentityFieldsNavigation.Close)
            else -> {}
        }
