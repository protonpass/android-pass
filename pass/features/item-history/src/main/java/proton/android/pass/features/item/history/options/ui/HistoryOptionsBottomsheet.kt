...
@Composable
fun HistoryOptionsBottomsheet(
    modifier: Modifier = Modifier,
    viewmodel: HistoryOptionsViewmodel = hiltViewModel(),
    ...
    HistoryOptionsContent(
        ...
        onReset = {
            onNavigated(
                ItemHistoryNavDestination.ConfirmResetHistory(viewmodel.shareId, viewmodel.itemId)
            )
        }
    )
}
