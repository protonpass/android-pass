...
class FakeAutofillFieldId(val id: Int = Random.nextInt()) : AutofillFieldId {
    ...
    companion object CREATOR : Parcelable.Creator<FakeAutofillFieldId> {
        override fun createFromParcel(parcel: Parcel): FakeAutofillFieldId = FakeAutofillFieldId(parcel)
        override fun newArray(size: Int): Array<FakeAutofillFieldId?> = arrayOfNulls(size)
    }
}
