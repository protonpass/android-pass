...
@Singleton
class FakeObserveCanCreateItems @Inject constructor() : ObserveCanCreateItems {

    private var canCreateItemsFlow = testFlow<Boolean>()

    fun emit(canCreateItems: Boolean) {
