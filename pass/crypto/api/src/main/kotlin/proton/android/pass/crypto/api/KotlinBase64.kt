...
open class KotlinBase64 private constructor(
...
//        check(payload == 0) // the padded bits are allowed to be non-zero
     ...
     */
    public companion object Default : KotlinBase64(isUrlSafe = false, isMimeScheme = false) {
         ...
         * The character `'='` is used for padding.
         */
        public val UrlSafe: KotlinBase64 = KotlinBase64(isUrlSafe = true, isMimeScheme = false)
         ...
         * The character `'='` is used for padding.
         */
        public val Mime: KotlinBase64 = KotlinBase64(isUrlSafe = false, isMimeScheme = true)
    }
}
...
private val base64DecodeMap = IntArray(256).apply {
    this.fill(-1)
    this[KotlinBase64.padSymbol.toInt()] = -2
...
internal fun KotlinBase64.platformCharsToBytes(source: CharSequence, startIndex: Int, endIndex: Int): ByteArray {
...
internal fun KotlinBase64.platformEncodeToString(source: ByteArray, startIndex: Int, endIndex: Int): String {
    val byteResult = encodeToByteArrayImpl(source, startIndex, endIndex)
    return String(byteResult, Charsets.ISO_8859_1)
}

internal fun KotlinBase64.platformEncodeIntoByteArray(
    source: ByteArray,
    destination: ByteArray,
    destinationOffset: Int,
    startIndex: Int,
...
internal fun KotlinBase64.platformEncodeToByteArray(
    source: ByteArray,
    startIndex: Int,
    endIndex: Int
): ByteArray {
