...
@Stable
internal data class SimpleLoginSyncMailboxChangeState(
    internal val showInvalidMailboxEmailError: Boolean,
    internal val event: SimpleLoginSyncMailboxChangeEvent,
    ...
    internal fun canChangeMailbox(mailboxEmail: String): Boolean = mailboxEmail.isNotEmpty()
        .and(!isLoading)
        .and(!showInvalidMailboxEmailError)

    internal companion object {

        internal val Initial = SimpleLoginSyncMailboxChangeState(
            event = SimpleLoginSyncMailboxChangeEvent.Idle,
