...
@Singleton
class ObserveBreachCustomEmailsImpl @Inject constructor(
    private val breachRepository: BreachRepository,
    private val observeCurrentUser: ObserveCurrentUser
) : ObserveBreachCustomEmails {
    override fun invoke(): Flow<List<BreachCustomEmail>> = observeCurrentUser()
        .flatMapLatest { user ->
            breachRepository.observeCustomEmails(user.userId)
        }
}
