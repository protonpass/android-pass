...
class ObserveOrganizationPasswordPolicyImpl @Inject constructor(
    private val observeOrganizationSettings: ObserveOrganizationSettings
) : ObserveOrganizationPasswordPolicy {

    override fun invoke(): Flow<Option<OrganizationPasswordPolicy>> = observeOrganizationSettings()
            ...
            when (organizationSettingsOption) {
                ...
                is Some -> {
                    when (val organizationSettings = organizationSettingsOption.value) {
                        ...
                        is OrganizationSettings.Organization -> organizationSettings.passwordPolicy.some()
                    }
                }
            }
        }
