...
package proton.android.pass.autofill.sample.personalinfoactivity
...
class PersonalInfoActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.postalCodeEditText.setAutofillHints(View.AUTOFILL_HINT_POSTAL_CODE)
        binding.phoneEditText.setAutofillHints(View.AUTOFILL_HINT_PHONE)
