...
@Singleton
class UpdateAliasAddressMonitorStateImpl @Inject constructor(
    ...
    override suspend fun invoke(
        ...
        if (userId != null) {
            breachRepository.updateAliasAddressMonitorState(userId, shareId, itemId, enabled)
        } else {
            val user = observeCurrentUser().filterNotNull().first()
            breachRepository.updateAliasAddressMonitorState(user.userId, shareId, itemId, enabled)
        }
    }
}
