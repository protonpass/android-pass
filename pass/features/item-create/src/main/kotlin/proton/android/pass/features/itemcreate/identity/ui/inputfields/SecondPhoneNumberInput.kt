...
@Composable
internal fun SecondPhoneNumberInput(
    ...
    ProtonTextField(
        ...
        editable = enabled,
        label = { ProtonTextFieldLabel(text = stringResource(id = R.string.identity_field_phone_number_title)) },
        placeholder = {
            ProtonTextFieldPlaceHolder(
                text =
                stringResource(id = R.string.identity_field_phone_number_hint)
            )
        },
        trailingIcon = {
            if (value.isNotEmpty()) {
