...
fun AddCustomFieldButton(
    ...
    Button.Circular(
        ...
        Row(
            ...
            Icon.Default(id = CoreR.drawable.ic_proton_plus, tint = adjustedTextColor)
            Text.Body1Regular(
...
@Preview
@Composable
fun AddCustomFieldButtonPreview(@PreviewParameter(ThemePreviewProvider::class) isDark: Boolean) {
