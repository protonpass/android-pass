package me.proton.pass.presentation.components.dialogs
...
fun ConfirmMoveItemToTrashDialog(
    ...
    ProtonAlertDialog(
        ...
        text = {
            ProtonAlertDialogText(text = stringResource(R.string.alert_confirm_item_send_to_trash_message, itemName))
        },
        confirmButton = {
            ProtonTextButton(
                onClick = onConfirm,
