...
internal class RustPasswordStrengthCalculatorTest {
    ...
    private val calculator = RustPasswordStrengthCalculator()

    @Test
    internal fun `GIVEN an empty password WHEN calculating password strength THEN return password strength None`() {
        val password = ""
        val expectedPasswordStrength = PasswordStrength.None

        val passwordStrength = calculator.calculateStrength(password)
