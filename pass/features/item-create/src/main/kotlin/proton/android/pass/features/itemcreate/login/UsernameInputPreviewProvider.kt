...
internal class UsernameInputPreviewProvider : PreviewParameterProvider<UsernameInputPreview> {

    override val values: Sequence<UsernameInputPreview> = sequence {
...
internal data class UsernameInputPreview(
    val text: String,
