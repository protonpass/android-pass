...
class FakeMoveFolder @Inject constructor() : MoveFolder {
    ...
    private var result: Result<Folder> =
        Result.failure(IllegalStateException("FakeMoveFolder result not set"))
    ...
    override suspend fun invoke(
        ...
        memory.add(Payload(shareId, folderId, newParentFolderId))
    ...
    data class Payload(
        ...
        val newParentFolderId: FolderId?
    )
}
