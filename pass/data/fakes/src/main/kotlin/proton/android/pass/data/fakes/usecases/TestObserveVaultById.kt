...
@Singleton
class TestObserveVaultById @Inject constructor() : ObserveVaultById {

    private val flow: MutableStateFlow<Option<Vault>> = MutableStateFlow(None)
    private var exceptionOption: Option<Exception> = None

    fun emitValue(value: Option<Vault>) {
        flow.tryEmit(value)
    }
