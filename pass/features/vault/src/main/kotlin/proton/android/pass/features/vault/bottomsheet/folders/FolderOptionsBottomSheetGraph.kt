...
object FolderOptionsBottomSheet : NavItem(
    baseRoute = "folder/options/bottomsheet",
...
internal fun NavGraphBuilder.bottomSheetFolderOptionsGraph(onNavigate: (VaultNavigation) -> Unit) {
    bottomSheet(FolderOptionsBottomSheet) {
        FolderOptionsBottomSheet(onNavigate = onNavigate)
    }
}
