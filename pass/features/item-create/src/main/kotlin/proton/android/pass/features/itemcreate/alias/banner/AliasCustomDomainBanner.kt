        ...
        content = {
            Row(verticalAlignment = Alignment.CenterVertically) {
                FeatureDiscoveryText(
                    ...
                    title = stringResource(R.string.banner_custom_domain_title),
...
@Preview
@Composable
fun AliasCustomDomainBannerPreview(@PreviewParameter(ThemePreviewProvider::class) isDark: Boolean) {
