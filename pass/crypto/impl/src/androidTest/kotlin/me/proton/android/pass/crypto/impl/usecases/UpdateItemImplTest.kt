...
import me.proton.android.pass.crypto.impl.extensions.serializeToProto
...
class UpdateItemImplTest {
    ...
    fun canUpdateItem() {
        ...
        val contents = ItemContents.Note(title = TestUtils.randomString(), note = TestUtils.randomString())
