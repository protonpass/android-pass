...
import proton.android.pass.data.impl.usecases.breach.ObserveHasBreachesImpl
...
import proton.android.pass.data.impl.usecases.breach.SendUserMonitorCredentialsReportImpl
...
abstract class DataUseCaseModule {
    ...
    @Binds
    abstract fun bindGetFolderHierarchy(impl: GetFolderHierarchyImpl): GetFolderHierarchy
    ...
    @Binds
    abstract fun bindCanCreateSecureLink(impl: CanCreateSecureLinkImpl): CanCreateSecureLink
    ...
    @[Binds Singleton]
    abstract fun bindObserveHasBreaches(impl: ObserveHasBreachesImpl): ObserveHasBreaches
    ...
    @[Binds Singleton]
    abstract fun bindCancelSimpleLoginAliasMailboxChange(
        impl: CancelSimpleLoginAliasMailboxChangeImpl
