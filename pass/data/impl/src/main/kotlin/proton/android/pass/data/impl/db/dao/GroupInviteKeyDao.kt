...
@Dao
abstract class GroupInviteKeyDao : BaseDao<GroupInviteKeyEntity>() {
    @Query(
        """
        SELECT * FROM ${GroupInviteKeyEntity.TABLE}
        WHERE ${GroupInviteKeyEntity.Columns.INVITE_ID} = :inviteId
