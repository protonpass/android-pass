...
@Composable
internal fun AboutSection(modifier: Modifier = Modifier, onEvent: (SettingsContentEvent) -> Unit) {
    Column(
        modifier = modifier,
...
@Preview
@Composable
internal fun AboutSectionPreview(@PreviewParameter(ThemePreviewProvider::class) isDark: Boolean) {
