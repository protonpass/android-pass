...
class AddOnePasswordHistoryEntryToUserImpl @Inject constructor(
    private val repository: PasswordHistoryEntryRepository,
    private val accountManager: AccountManager
) : AddOnePasswordHistoryEntryToUser {
    override suspend fun invoke(passwordHistoryEntry: PasswordHistoryEntry) {
        accountManager.getPrimaryUserId().firstOrNull()?.let {
            repository.addOnePasswordHistoryEntryForUser(userId = it, passwordHistoryEntry = passwordHistoryEntry)
        }
    }
}
