...
class FilterBottomSheetViewModel @Inject constructor(
    ...
    val state: StateFlow<SearchFilterType> =
        homeSearchOptionsRepository.observeFilterOption()
            .map { it.searchFilterType }
            .stateIn(viewModelScope, SharingStarted.Eagerly, SearchFilterType.All)
