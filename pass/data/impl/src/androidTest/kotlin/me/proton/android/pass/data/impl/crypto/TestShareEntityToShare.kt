...
import me.proton.android.pass.crypto.fakes.usecases.TestReadKey
...
import me.proton.android.pass.data.fakes.repositories.TestVaultKeyRepository
...
import me.proton.pass.domain.flags
import me.proton.pass.domain.hasFlag
...
class TestShareEntityToShare {
    ...
    fun setup() {
        ...
        vaultKeyRepository.setVaultKeys(Result.Success(listOf(
            VaultKey(
