...
@Singleton
class FakeGetPasswordHistoryEntryForUser @Inject constructor() : GetPasswordHistoryEntryForUser {
    override suspend fun invoke(): List<PasswordHistoryEntry> = emptyList()
}
