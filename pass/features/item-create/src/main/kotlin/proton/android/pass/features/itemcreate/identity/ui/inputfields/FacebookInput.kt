...
internal fun FacebookInput(
    ...
    ProtonTextField(
        ...
        editable = enabled,
        label = { ProtonTextFieldLabel(text = stringResource(id = R.string.identity_field_facebook_title)) },
        placeholder = {
            ProtonTextFieldPlaceHolder(
                text =
                stringResource(id = R.string.identity_field_facebook_hint)
            )
        },
        trailingIcon = {
            if (value.isNotEmpty()) {
