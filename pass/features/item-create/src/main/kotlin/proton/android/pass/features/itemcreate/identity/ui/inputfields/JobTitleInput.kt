...
internal fun JobTitleInput(
    ...
    ProtonTextField(
        ...
        editable = enabled,
        label = { ProtonTextFieldLabel(text = stringResource(id = R.string.identity_field_job_title_title)) },
        placeholder = {
            ProtonTextFieldPlaceHolder(
                text =
                stringResource(id = R.string.identity_field_job_title_hint)
            )
        },
        trailingIcon = {
            if (value.isNotEmpty()) {
