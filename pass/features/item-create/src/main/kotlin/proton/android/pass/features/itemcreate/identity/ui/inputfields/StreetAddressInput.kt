...
@Composable
internal fun StreetAddressInput(
    ...
    ProtonTextField(
        ...
        editable = enabled,
        label = { ProtonTextFieldLabel(text = stringResource(id = R.string.identity_field_street_address_title)) },
        placeholder = {
            ProtonTextFieldPlaceHolder(
                text =
                stringResource(id = R.string.identity_field_street_address_hint)
            )
        },
        trailingIcon = {
            if (value.isNotEmpty()) {
