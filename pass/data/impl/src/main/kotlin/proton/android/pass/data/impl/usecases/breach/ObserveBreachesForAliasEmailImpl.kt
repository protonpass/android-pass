...
@Singleton
class ObserveBreachesForAliasEmailImpl @Inject constructor(
    ...
    override fun invoke(
        ...
        observeCurrentUser()
            .flatMapLatest { user ->
                breachRepository.observeBreachesForAliasEmail(user.userId, shareId, itemId)
            }
    } else {
        breachRepository.observeBreachesForAliasEmail(userId, shareId, itemId)
    }
