...
class DeleteSimpleLoginAliasMailboxImpl @Inject constructor(
    private val repository: SimpleLoginRepository
) : DeleteSimpleLoginAliasMailbox {

    override suspend fun invoke(mailboxId: Long, transferMailboxId: Long?) {
        repository.deleteAliasMailbox(mailboxId, transferMailboxId)
    }
