...
internal fun LastNameInput(
    ...
    ProtonTextField(
        ...
        editable = enabled,
        label = { ProtonTextFieldLabel(text = stringResource(id = R.string.identity_field_last_name_title)) },
        placeholder = {
            ProtonTextFieldPlaceHolder(
                text =
                stringResource(id = R.string.identity_field_last_name_hint)
            )
        },
        trailingIcon = {
            if (value.isNotEmpty()) {
