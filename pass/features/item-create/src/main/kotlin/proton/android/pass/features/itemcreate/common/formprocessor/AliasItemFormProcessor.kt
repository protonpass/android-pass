...
import proton.android.pass.features.itemcreate.alias.toError
...
@Singleton
class AliasItemFormProcessor @Inject constructor(
    ...
    data class Input(
        ...
        val formState: AliasItemFormState
    )
    ...
    override suspend fun process(
        ...
        aliasPrefixValidator.validate(input.formState.prefix).onFailure {
        ...
        if (input.formState.selectedMailboxes.isEmpty()) {
            errors += AliasItemValidationError.NoMailboxes
        }
